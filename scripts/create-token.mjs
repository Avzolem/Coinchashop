...
const MY_TOKEN_METADATA = {
    name: "SuperTeamMX Coincha",
    symbol: "STC",
    description: "A demo token for SuperteamMX",
    image: "https://res.cloudinary.com/da2ckztvt/image/upload/v1690792939/Fzmb48HWwAEtDVH_qzhmwj.jpg",
};
